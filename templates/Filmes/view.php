                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?= h($ators->created) ?></td>
                            <td><?= h($ators->modified) ?></td>
                            <td><?= h($ators->deleted) ?></td>
                            <td class="actions">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?= h($criticas->created) ?></td>
                            <td><?= h($criticas->modified) ?></td>
                            <td><?= h($criticas->deleted) ?></td>
                            <td class="actions">
